...
class ProductStockRepository extends ServiceEntityRepository
{
    ...
    public function FindStockChangedOfProduct($companyId,$productId){
  

        return $this->createQueryBuilder('productStock')
            ->andWhere('productStock.company = :val')
            ->andWhere('productStock.product = :id')
